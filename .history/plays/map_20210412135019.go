...
func (d *Map) Update(screen *ebiten.Image) (err error) {
	...
	if d.count%60 == 0 {
		var a = &core.Animator{
			...
			Interval: 1,
			Order:    "loop",
			Imgs: []*ebiten.Image{core.Nodes.Img["t1png"].SubImage(image.Rect(0, 0, 100, 100)).(*ebiten.Image),
				core.Nodes.Img["t1png"].SubImage(image.Rect(0, 0, 100, 100)).(*ebiten.Image),
				core.Nodes.Img["t1png"].SubImage(image.Rect(0, 0, 100, 100)).(*ebiten.Image),
				core.Nodes.Img["t2png"].SubImage(image.Rect(0, 0, 100, 100)).(*ebiten.Image),
				core.Nodes.Img["t2png"].SubImage(image.Rect(0, 0, 100, 100)).(*ebiten.Image),
				core.Nodes.Img["t2png"].SubImage(image.Rect(0, 0, 100, 100)).(*ebiten.Image),
			},
		}
